...
#fil1 = 'geo_em.d03.nc'
fil1 = 'wrfout_d03_2018-07-14_12:00:00'
fil3 = 'ASOS_0715-0820_forValid_revised.csv'
mlat = np.array([37.5714])
mlon = np.array([126.9658])

interpT = wi.intp_valid(fil1,mlat,mlon,"T2")[3+12*24:12*24+dlen+3] -273.15
interpU = wi.intp_valid(fil1,mlat,mlon,"U10")[3+12*24:12*24+dlen+3]
interpV = wi.intp_valid(fil1,mlat,mlon,"V10")[3+12*24:12*24+dlen+3]
...
b.date_csv()
DATE = b.DATE[12*24:12*24+dlen]
print(DATE)
gdata = b.gdata[12*24:12*24+dlen,:]
...
#plt.show()
plt.savefig('./era5temp_valid.png',bbox_inches='tight')
...
plt.legend()
#plt.show()
plt.savefig('./era5temp_series.png',bbox_inches='tight')
...
plt.plot([sx,ex],[sx,ex],'k')
#plt.show()
plt.savefig('./era5ws_valid.png',bbox_inches='tight')
...
plt.legend()
#plt.show()
plt.savefig('./era5ws_series.png',bbox_inches='tight')
...
plt.plot([sx,ex],[sx,ex],'k')
#plt.show()
plt.savefig('./era5wd_valid.png',bbox_inches='tight')
...
plt.legend()
#plt.show()
plt.savefig('./era5wd_series.png',bbox_inches='tight')
