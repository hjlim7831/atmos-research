...
fig, ax = plt.subplots(ncols = 1, nrows = 3, figsize=(4,14))
#plt.title('Mean 10 m windspeed observed vs WRF',fontsize=fs)
...
fig.text(0.17,0.894,'(a)',fontsize=fsp1+5)
fig.text(0.17,0.615,'(b)',fontsize=fsp1+5)
fig.text(0.17,0.332,'(c)',fontsize=fsp1+5)



#plt.tight_layout()
plt.savefig("../picture/aws_meantwq_valid_"+fil1+".png")
plt.show()
