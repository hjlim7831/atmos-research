...
plt.plot(np.arange(0,24),mpr1[312:336],label="alb0.2")
plt.plot(np.arange(0,24),mpr2[312:336],label="alb0.7")
...
var = ['maxut','maxuhi2','maxuhi3','meanpr1','meanpr2','meanw1','meanw2','w115','w215','wdano1','wdano2']
