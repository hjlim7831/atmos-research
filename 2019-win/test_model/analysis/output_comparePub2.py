...
ax[0].set_xlim([datetime.datetime(2018,7,28,0,0,0),datetime.datetime(2018,7,29,0,0,0)])
...
ax[1].set_xlim([datetime.datetime(2018,7,28,0,0,0),datetime.datetime(2018,7,29,0,0,0)])
...
#plt.tight_layout()
plt.savefig('../picture/compare_alb_pub.png',bbox_inches='tight')
#plt.show()

print(mut2[673:700]-mut1[673:700])
