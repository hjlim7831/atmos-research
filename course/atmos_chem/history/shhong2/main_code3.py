...
P_z = np.array([79.501, 70.121, 61.660, 54.048], dtype = 'float64')*((10.)**(3.))
T_z = np.array([275.154, 268.659, 262.166, 255.676], dtype = 'float64')
...
t = 300000.            # total integration time [s]
dt = 10. # time mesh [s]
