...
\mv regress.s ../regress/reg_sce-z850.d
...
2
0
../regress/blo_sce-z850_reg.d
SEQ
2
../regress/reg_sce-z850.d
(///,20(7X,E13.5,/),/)
../results/cinf_sce.d
...
cat >! recast.com <<ENDc
../results/eof_z850.data
DIR
nofile
42            ; number of eof modes used
11520
1.0            ; scale factor
240 48
../regress/blo_sce-z850_reg.d
