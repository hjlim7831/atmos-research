...
\mv regress.s ../regress/reg_sic-sh850.d
...
2
0
../regress/blo_sic-sh850_reg.d
SEQ
2
../regress/reg_sic-sh850.d
(///,20(7X,E13.5,/),/)
../results/cinf_sic.d
...
cat >! recast.com <<ENDc
../results/eof_sh850.data
DIR
nofile
185            ; number of eof modes used
11520
1.0            ; scale factor
240 48
../regress/blo_sic-sh850_reg.d
...
../results/csf_sic-sh850_reg.data
DIR
ENDc
./recast < recast.com
